...
describe 'Home' do
  ...
  describe 'Sign-In & Register' do
    ...
    it 'should sign-in and register sdg user', :browser, :suite => 'smoke' do
  ...
  describe 'Register user' do
    ...
    it 'should select attendance:yes for sdg user', :browser, :suite => 'smoke' do
      sign_in_sdg_auth_user
    ...
    it 'should select attendance:tuesday only for sdg user', :browser, :suite => 'smoke' do
      sign_in_sdg_auth_user

      @register_modal.select_attendance('I can only go on Tuesday')
      sleep 3 #to see what option selected - need to remove later
      @register_modal.click_submit
    end
